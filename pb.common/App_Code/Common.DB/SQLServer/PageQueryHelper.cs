namespace Common.DB.SQLServer
{
    ...
    public class PageQueryHelper : IPageQueryHelper
    {
        ...
        {
            return "select count(" + this.identity + ") from " + this.table + " with(nolock)  where " + this.where;
        }
        ...
        System.Text.RegularExpressions.Regex zeroFR = new System.Text.RegularExpressions.Regex(@"^0,");
